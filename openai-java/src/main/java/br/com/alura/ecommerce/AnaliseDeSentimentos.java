...
public class AnaliseDeSentimentos {
    ...
    private static String carregarArquivo(String arquivo) {
        try {
            var path = Path.of("openai-java/src/main/resources/avaliacoes/avaliacoes-" +arquivo +".txt");
    ...
    private static void salvarAnalise(String arquivo, String analise) {
        try {
            var path = Path.of("openai-java/src/main/resources/analises/analise-sentimentos-" +arquivo +".txt");
